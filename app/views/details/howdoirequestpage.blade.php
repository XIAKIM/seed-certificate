@extends('index')
@section('content')
	<h1>How to make a PP request</h1>
			<br></br>
			<p class = "lead">
			Step 1 : Click on the "Request" button at the top of the page. (insert image)
			<br><br>
			Step 2 : Choose Seed transaction that you want to request.
			<br><br>
			Step 3 : Click on the transaction name if you want to view the details of each transaction. (insert image)
			<br><br>
